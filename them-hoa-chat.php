                ...
                <form action="" method="POST" enctype="multipart/form-data" >
                  <div class="wrapper">
                    ...
                    <div  style="display: flex;">
                      ...
                      <div style="width: 85%;" id="lbform" class="form-control-label">
                        <label class="form-control-label">HSD sau mở nắp</label>
                      </div>
                      <div style="width: 95%;"id="lbform" class="form-control-label">
                    ...
                    <div  style="display: flex;">
                      ...
                      <div style="width: 110%"class="form-group">
                        <input type="text" value="" name="songayhethan[]" placeholder="HSD sau mở nắp"class="form-control" >
                      </div>
                      <div style="width: 110%"class="form-group">
