                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">DANH SÁCH KHOA</strong>
                        </div>
                        <div class="card-body">
                            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                  <?php
                                  $soTT = 0;
                                  $sql = "SELECT MaKhoa, TenKhoa FROM tblkhoa WHERE Loai = 1";
                                  ...
                                  while ($row = mysqli_fetch_array($query)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a title="<?php echo $row[1] ?>" href="mon-hoc.php?id=<?php echo $row['MaKhoa'] ?>"  class="ti-eye"></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
