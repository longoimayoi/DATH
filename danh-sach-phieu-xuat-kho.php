...
<body>
                        ...
                        <div class="card-body">
                            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                      <?php
                                       $soTT = 0;
                                        $sql = "SELECT MaPhieu, TenDangNhap, NgayLapPhieu, GhiChu FROM tbl_phieuxuatkho pxk, tbltaikhoan tk WHERE pxk.NguoiLap = tk.MaTK ORDER BY NgayLapPhieu DESC";
    ...
    if(isset($_POST['submit']))
    {
        ...
        $GhiChu=$_POST['GhiChu'];
        $NgayLap = date("Y-m-d", strtotime($NgayLapPhieu));
                            ...
                            <form method = "post" >
                                <div id="checkopenedit">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text"class="form-control" name="NgayLap" value ="<?php echo date("d/m/Y") ?>"></div>
                                    </div>
                                    <div class="row form-group">
