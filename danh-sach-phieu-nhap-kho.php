                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <th width="5%">Số thứ tự </th> 
                                        <th width="5%">Mã Phiếu</th>
                                        <th width="20%">Ngày duyệt phiếu</th>
                                        <th width="10%">Tỷ lệ hoàn thành</th>
                                        <th width="5%"></th>
                                    </tr>
                                </thead>
                                <tbody>
                                  <?php
                                  $soTT = 0;
                                  $sql = "SELECT * FROM tblhoadon hd, tbltaikhoan tk WHERE hd.MaTK = tk.MaTK and hd.TrangThai = 3 ORDER BY MaHD DESC";
                                  ...
                                  while ($row = mysqli_fetch_array($query)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row["NgayLDPQTDuyet"] ?></td>
                                        <td>
                                         <div class="progress">
                                          <div class="progress-bar" role="progressbar" style="width: <?php echo $row["MucDoHoanThanh"] ?>%;" aria-valuenow="<?php echo $row["MucDoHoanThanh"] ?>" aria-valuemin="0" aria-valuemax="100"><?php echo $row["MucDoHoanThanh"] ?>%</div>
                                      </div>
                                      <td>
                                        <a title="Xem chi tiết" href="chi-tiet-phieu-nhap-kho.php?id=<?php echo $row['MaHD'] ?>"  class="ti-eye"></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
