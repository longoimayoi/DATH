      ...
      <div class="card"> -->
        ...
        <!--  <div class="card-body card-block">
          <div class="row">
            <div class="col-6">
              <?php
              $query1="SELECT TongTien,MonHoc,NhomLop,SLSV,MaKhoa,NamHoc,HocKy,TrangThai,GhiChu,HocPhiCoBan, LyDoHuy FROM tblhoadon WHERE MaHD='$id' ";
          ...
          <div class="col-lg-12">
            <div class="card">
              <form method="post" >
                ...
                <?php
                $sqlTTP = "SELECT * FROM tblhoadon WHERE MaHD=".$id;
                    ...
                    <table class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <td> <select name = "TinhTrang[]">
                          <option class="form-control" value="0" <?php if($ttn==0) echo 'selected' ?> >Không</option>
                          <option class="form-control" value="1" <?php if($ttn==1) echo 'selected' ?> >Có</option>
                          <option class="form-control" value="2" <?php if($ttn==2) echo 'selected' ?> >Thiếu</option>
                        </select>
                      </td>
                    </tbody>
                    <?php } ?>
